...
if __name__ == "__main__":
    if not os.path.exists("data/ReinforcementLearning/raw_materials"):
        os.makedirs("data/ReinforcementLearning/raw_materials")

    filter_tool = QCHcuristicFilter(threshold=10)
    ...
    for sample in dataset:
        ...
        if passed:
            ...
            if counter % 100 == 0:
                ...
                # Save it to "data/ReinforcementLearning/raw_materials/QC_corpus_chunk_<counter>.jsonl"
                with open(f"data/ReinforcementLearning/raw_materials/QC_corpus_chunk_{counter}.jsonl", "w") as f:
